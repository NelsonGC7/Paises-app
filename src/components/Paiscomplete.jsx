...
export const Paiscomplete = ({ urlImg,namePais,nameN,population,region,subregion,capital,domain,current,lengua,border1,border2,border3 })=>{
    return(
        <section className="infoCompleta">
            <button> <img src={btonBack} alt="" /></button>
            <article className='infoCompleta__info'>
                ...
                <div className='infoCompleta__info-INFO'>
                    ...
                    <div className='infoCompleta__info-INFO-box'>
                        <div className=' infoCompleta__info-INFO-box1'>
                        ...
                        <div className=' infoCompleta__info-INFO-box2'>
                    ...
                    <div className='infoCompleta__info-INFO-border'>
